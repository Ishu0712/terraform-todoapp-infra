terraform {
  ...
  backend "azurerm" {
    ...
    tenant_id            = "e7bcfba0-e88d-4265-b3b5-f112aa9b2518"  # Can also be set via `ARM_TENANT_ID` environment variable. Azure CLI will fallback to use the connected tenant ID if not supplied.
